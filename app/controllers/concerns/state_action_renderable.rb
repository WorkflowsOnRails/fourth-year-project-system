...
# The StateActionRenderable concern implements a controller-based helper
...
module StateActionRenderable
  ...
  def render_state_actions(taskable)
    ...
    events = taskable.aasm.events.select { |event| a_policy.send("#{event}?") }
